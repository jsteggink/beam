...
public class ElasticsearchIOTest extends ESIntegTestCase implements Serializable {
  ...
  public void setup() throws Exception {
    if (connectionConfiguration == null){
      ...
      elasticsearchIOTestCommon = new ElasticsearchIOTestCommon(connectionConfiguration,
          new RestHighLevelTestClient(getRestClient(), RestClient::close, Collections.emptyList()),
          false);
    }
  }
  ...
  public void testSplit() throws Exception {
    ...
    ElasticSearchIOTestUtils
        .insertTestDocuments(connectionConfiguration, NUM_DOCS_UTESTS,
            new RestHighLevelTestClient(
                getRestClient(), RestClient::close, Collections.emptyList()));
